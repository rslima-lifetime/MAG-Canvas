...
export const TableFormatMenu: React.FC<TableFormatMenuProps> = ({
  ...
  return (
    <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 bg-white shadow-2xl border border-slate-200 rounded-xl py-2 w-56 z-[100] animate-in fade-in slide-in-from-top-2 text-left">
      ...
      <div className="px-3 py-1.5 mb-1 text-[10px] font-black uppercase text-slate-400 flex items-center justify-between">
          ...
          {FORMAT_OPTIONS.map((opt) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-xs uppercase tracking-tight">{opt.label}</span>
        ...
        {isNumeric && (
          <div className="px-3 py-3 border-t bg-slate-50/30">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Casas Decimais</span>
            </div>
        ...
        {isNumeric && (
          <div className="px-3 py-3 border-t bg-slate-50/50">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Meta Específica</span>
            </div>
            <input 
              type="number"
              value={currentGoal}
              ...
              className="w-full p-1.5 text-xs font-black border rounded bg-white text-[#006098] outline-none focus:ring-1 focus:ring-blue-200"
              placeholder="Ex: 100"
            />
          </div>
        )}
